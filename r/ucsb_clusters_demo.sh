...
R CMD BATCH --quiet --no-restore --no-save /home/saraorofino/emlab-cloud-computing-demo/r/ucsb_clusters_demo_analysis_script.R # Path to the script you want to run 
