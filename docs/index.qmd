...
- Overview of UCSB servers
- Comparing the two approaches
- Live demos of Google VMs and UCSB servers
...
- The ability to run software and packages on specific operating systems 
...
- [GPUs](https://cloud.google.com/compute/docs/gpus) are also available
...
- For Google VMs - Can also use Google Cloud Storage with the [googleCloudStorageR](https://code.markedmondson.me/googleCloudStorageR/) package
...
- Depending on how many people anare going to be using this, we may need to think about how to better monitor and manage billing across projects